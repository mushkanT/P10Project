...
parser.add_argument('--cross_depth',    type=int,           default=1,             help='The depth at which images should cross between coupled models. Must be <= model_depth (see argument above')
