...
def batch_pairwise_distances(U, V):
    """ Compute pairwise distance between two batches of feature vectors """
...
class DistanceBlock:
    """ Provides multi-GPU support to calculate pariwise distances between two batches of feature vectors """
